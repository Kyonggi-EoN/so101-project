...
```
<종류>/<깃허브-아이디>/<주제>       예: feat/jsjin7371/hand-tracking
```
...
- 브랜치 하나 = PR 하나
- 커밋 메시지는 `<종류>: <무엇을 했는지>` 형식으로 쓴다 (`feat:`, `fix:`, `docs:`, `refactor:`, `chore:`, `test:`)
- 규칙은 **`master` 로 들어오는 PR** 에만 적용된다. 그 아래 브랜치를 어떻게 나누든 자유다
